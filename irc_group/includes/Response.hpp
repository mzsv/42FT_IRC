...
/*   Updated: 2024/07/26 19:36:24 by amenses-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef std::string (*RplFunctionPointer)(IrcCode);

class Response
{
  private:
    static const Server* server_;
  ...
  public:
    static void set_targets(const User* user, const Channel* channel);
