...
/*   Updated: 2024/07/11 18:57:10 by amenses-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Response.hpp"

std::map<IrcCode, std::string> irc_messages = Response::initialize_irc_messages();

std::map<IrcCode, std::string> initialize_irc_messages()
{
...
std::string generate_message(IrcCode code, std::map<std::string, std::string>& params)
{
...
void Response::error_reply(const User& user, IrcCode code, std::map<std::string, std::string>& params)
{
	std::string message = Response::generate_message(code, params);
